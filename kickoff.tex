        ...
        \begin{frame}
            ...
            \begin{columns}\label{mochizuki}
                \column{0.80\textwidth}
                    ...
                    Mochizuki developed inter-universal Teichmüller theory, which has attracted a high level of attention of non-mathematicians due to claims it provides a resolution of the \hyperlink{abc}{\beamerbutton{abc conjecture}} (also known as Oesterl ́e–Masser conjecture).
                \pause
    ...
    \section{The Bibliography}
        ...
        \begin{frame}
            ...
            \begin{center}
                ...
                \hyperlink{init}{\beamerbutton{\start again \ding{242}}}\\
            \end{center}
        \end{frame}
